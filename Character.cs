...
public class Character : MonoBehaviour
{
    ...
    {
        //for daily goals
        currentExtension = PlayerPrefs.GetInt("CurrentExtension");
        currentRadial = PlayerPrefs.GetInt("CurrentRadial");
        currentPronation = PlayerPrefs.GetInt("CurrentPronation");
    ...
    { 
        if (reps > 0)
        {
            if (isExtension)
            {
                ...
                {
                    countDownTimer.text = "Exceeded the threshold!\nReduce the angle!";
                    currentTime = sliderScript.holdTime;
                }
                else
                {
            ...
            {
                countDownTimer.text = "Continue Flexion";
        ...
        if (reps <= 0)
        {
            ...
            stopExerciseExtensionButton.SetActive(false);
            currentExtension++;
            PlayerPrefs.SetInt("CurrentExtension", currentExtension);
    ...
    public void LeftWristRadial()
    {
        ...
        if (reps > 0)
        {
            if (isRadial)
            {
                countDownRadialTimer.text = "Continue Radial Deviation";
                if (leftRadialAngle >= sliderScript.radialBaseAngle && leftRadialAngle <= sliderScript.radialBaseAngle + 2)
                {
                    ...
                    countDownRadialTimer.text = "Hold Time Remaining: " + currentRadialTime.ToString("0");
                ...
                {
                    countDownRadialTimer.text = "Exceeded the threshold! Reduce the angle!";
                    currentRadialTime = sliderScript.holdTimeRadial;
                }
                else
                {
            ...
            if (isRadial == false)
            {
                countDownRadialTimer.text = "Continue Ulnar Deviation";
        ...
        if (reps <= 0)
        {
            ...
            stopExerciseRadialButton.SetActive(false);
            currentRadial++;
            PlayerPrefs.SetInt("CurrentRadial", currentRadial);
        }
    }
    ...
    public void LeftWristPronation()
    {
        ...
        if (reps > 0)
        {
            if (isPronation)
            {
                countDownTimer.text = "Continue Pronation";
                if (leftPronationAngle >= sliderScript.pronationBaseAngle && leftPronationAngle <= sliderScript.pronationBaseAngle + 2)
                {
                    ...
                    countDownPronationTimer.text = "Hold Time Remaining: " + currentPronationTime.ToString("0");
                ...
                {
                    countDownPronationTimer.text = "Exceeded the threshold! Reduce the angle!";
                    currentPronationTime = sliderScript.holdTimePronation;
                }
                else
                {
                    countDownPronationTimer.text = "Continue Pronation";
                    currentPronationTime = sliderScript.holdTimePronation;
                }
            }
            if (isPronation == false)
            {
                countDownPronationTimer.text = "Continue Supination";
        ...
        if (reps <= 0)
        {
            ...
            stopExercisePronationButton.SetActive(false);
            currentPronation++;
            PlayerPrefs.SetInt("CurrentPronation", currentPronation);
    ...
    {
        //
        streamFile = new FileStream("C:\\Unity Projects\\Wrist Rehabilitation Framework Final\\Wrist Rehabilitation Framework v2\\DataLog\\" + patientName + "_Extension_Flexion_" + timeStamp +  ".csv", FileMode.OpenOrCreate);
    ...
    {
        streamFile = new FileStream("C:\\Unity Projects\\Wrist Rehabilitation Framework Final\\Wrist Rehabilitation Framework v2\\DataLog\\" + patientName + "_Radial_Ulnar_" + timeStamp + ".csv", FileMode.OpenOrCreate);
        writeStream = new StreamWriter(streamFile);
    ...
    {
        streamFile = new FileStream("C:\\Unity Projects\\Wrist Rehabilitation Framework Final\\Wrist Rehabilitation Framework v2\\DataLog\\" + patientName + "_Pronation_Supination_" + timeStamp + ".csv", FileMode.OpenOrCreate);
        writeStream = new StreamWriter(streamFile);
